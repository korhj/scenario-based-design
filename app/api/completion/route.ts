...
const systemMessage = {
  role: "system",
  content: `
  "Your job is to createa a JSON file and nothing else. The JSON file must be correctly formatted. Create a JSON with following structure"
  ###
  {
    "Element1": {
      "Dimensions-Name": "anything here",
      "Dimensions-Option": "anything here",
  ...
  "use the give scenario as inspiration."
